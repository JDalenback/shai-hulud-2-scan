...
You execute the script by running `./scan-for-shai-hulud.sh`. By default the script will search for package.json files recursively from
the directory specified in the `$HOME`env variable.
